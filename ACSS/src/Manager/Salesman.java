...
public class Salesman {
    ...
    private static void updateUser(Scanner scanner) {
        ...
        if (user != null) {
            ...
            staffList.set(staffList.indexOf(user), new User(user.getId(), newName));
        ...
        if (user != null) {
            System.out.print("Enter new name: ");
            String newName = scanner.nextLine().trim();
            salesmanList.set(salesmanList.indexOf(user), new User(user.getId(), newName));
    ...
    private static boolean removeUserFromList(List<User> list, String id) {
        return list.removeIf(user -> user.getId().equalsIgnoreCase(id));
    }
